    ...
    function o(t) {
        (this.image = t),
            ...
            (this.calculateModuleSize = function (e, t, n) {
                return (
                    (this.calculateModuleSizeOneWay(e, t) + this.calculateModuleSizeOneWay(e, n)) /
                    2
                );
            }),
            ...
            (this.computeDimension = function (e, t, n, r) {
                var i =
                    7 +
                    ((Math.round(this.distance(e, t) / r) + Math.round(this.distance(e, n) / r)) >>
                        1);
                switch (3 & i) {
                    case 0:
                        i++;
    ...
    (A.imagedata = null),
        ...
        (A.setWebcam = function (e) {
            ...
            t.getUserMedia
                ...
                ? ((A.webkit = !0),
                  t.webkitGetUserMedia({ video: n, audio: !1 }, A.vidSuccess, A.vidError))
                : t.mozGetUserMedia &&
                  ((A.moz = !0),
        ...
        (A.grayscale = function () {
            for (
                var e = new ArrayBuffer(A.width * A.height), t = new Uint8Array(e), n = 0;
                n < A.height;
                n++
            )
                for (var r = 0; r < A.width; r++) {
    ...
    function D() {
        (this.image = null),
            ...
            (this.handlePossibleCenter = function (e, t, n) {
                ...
                if (
                    !isNaN(a) &&
                    ((i = this.crossCheckHorizontal(Math.floor(i), Math.floor(a), e[2], r)),
                    !isNaN(i))
                ) {
                    for (
    ...
    function F(e, t, n, r, i, a, o) {
        (this.image = e),
            ...
            (this.handlePossibleCenter = function (e, t, n) {
                ...
                if (!isNaN(a)) {
                    for (
                        var o = (e[0] + e[1] + e[2]) / 3, s = this.possibleCenters.length, h = 0;
                        h < s;
                        h++
                    ) {
                ...
                for (var e = new Array(); ; ) {
                    ...
                    if (7 == t) var n = this.parseECIValue();
                        ...
                        switch (t) {
                            case 1:
                                for (
                                    var i = this.getFigureString(r), a = new Array(i.length), o = 0;
                                    o < i.length;
                                    o++
                                )
                                    a[o] = i.charCodeAt(o);
